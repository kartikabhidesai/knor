<div class="wrapper wrapper-content white-bg m-t">
    <div class=" animated fadeInRightBig">
        <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?= user_url(); ?>project/edit/<?php echo $this->utility->encode($projectDetail[0]->projectID)?>" id='clientEdit'>

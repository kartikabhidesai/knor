 <!-- Header -->
    ...
    <section id="services">
        <div class="container">
            ...
            <div class="row text-center servicemain">
                <div class="col-md-4 sevicesinner">
    ...
    <section class="showcase">
        <div class="container-fluid p-0">
            <div class="row no-gutters greybg">
    ...
    <section class="bg-light" id="aboutus">
        <div class="container" id="smnothing">
            <div class="row">
                <div class="col-lg-4">
                ...
                <div class="bg-light col-lg-4" id="portfolio">
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="<?= base_url()?>public/front/img/Andrew.jpg" alt="">
                        </a>
                    </div>
                </div>
                <div class="bg-light col-lg-4" id="portfolio">
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="<?= base_url()?>public/front/img/Emily.jpg" alt="">
                        </a>
                    </div>
                </div>
        ...
        <div class="container" id="nothing">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading text-uppercase">ABOUT US</h2>
                    <h1 class="aboutinner">DRIVEN BY PURPOSE; DESIGNING WITH IMPACT!</h1>
                </div>
            </div>
            <div class="row">
    ...
    <section class="work" id="ourwork">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <a href="<?= base_url() . 'front/our_work'; ?>" class="btn cow-button btn-xl text-uppercase text-center"> Check Out Our Work</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="contact">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <h2 class="section-heading text-uppercase text-left text-primary">Contact Us</h2>
                    <h4 class="contactinner text-left">WE LOOK FORWARD TO HEARING FROM YOU!</h4>
                    <div class="contactinfo">
                        <p>OFFICE: 905.648.2225
                            <br>INFO@KNORGRAPHICS.COM</p>
                    ...
                    <form id="contactForm" name="sentMessage" novalidate="novalidate">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 text-left">
                                <div id="success"></div>
                                <button id="sendMessageButton" class="btn send-button btn-xl text-uppercase text-center" type="submit">Send</button>
                            </div>
                        </div>
                    </form>
                </div>
